      ...
      <View style={styles.headerContainer}>
        ...
        <View style={{ marginTop: 15, height: 40 }}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {['All', 'Sport', 'Luxury', 'Minimal', 'Classic'].map((cat, index) => (
              <TouchableOpacity key={index} style={{ marginRight: 20 }}>
                <Text style={[styles.categoryText, index === 0 && { color: COLORS.textDark, fontWeight: 'bold' }]}>
                  {cat}
                </Text>
              </TouchableOpacity>
            ))}
            ...
            <View style={styles.modalContent}>
                ...
                <View style={styles.filterSection}>
                    ...
                    <View style={{marginTop: 15}}>
                          <Text style={[styles.filterLabel, {marginBottom: 10}]}>Price Range</Text>
                ...
                <View style={styles.modalButtonRow}>
                    <TouchableOpacity style={styles.btnOutline} onPress={() => setFilterVisible(false)}>
                        <Text style={styles.btnTextOutline}>Clear All</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.btnFilled} onPress={() => setFilterVisible(false)}>
...
export function ArScreen() { 
  return (
    <View style={styles.centerScreen}>
      <Text style={{fontSize: 18, fontWeight: 'bold', color: COLORS.textDark}}>AR Camera View</Text>
    </View>
  ); 
}
...
export function ProfileScreen({ navigation }: any) {
  return (
    <View style={styles.centerScreen}>
      <Text style={{ fontSize: 20, marginBottom: 20, color: COLORS.textDark }}>My Profile</Text>
...
const styles = StyleSheet.create({
  ...
  centerScreen: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: COLORS.white },
  
  // Header
  headerContainer: { padding: 20, paddingBottom: 10, backgroundColor: COLORS.white },
  appTitle: { fontSize: 22, fontWeight: 'bold', color: COLORS.primary, marginBottom: 15 },
  ...
  filterBtn: { marginLeft: 10, padding: 10, borderWidth: 1, borderColor: COLORS.primary, borderRadius: 10 },
  ...
  cardTitle: { fontSize: 14, fontWeight: '600', color: COLORS.textDark, marginBottom: 4 },
  cardPrice: { fontSize: 14, fontWeight: 'bold', color: COLORS.primary },
  cardCategory: { fontSize: 10, color: COLORS.textLight, marginTop: 2 },
  
  logoutButton: { paddingVertical: 10, paddingHorizontal: 20, backgroundColor: '#EF4444', borderRadius: 8 },

  // --- Modal Styles ---
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' },
  modalContent: { width: width * 0.9, backgroundColor: 'white', borderRadius: 20, padding: 20, elevation: 5 },
  modalTitle: { fontSize: 20, fontWeight: 'bold', color: '#1E3A8A', textAlign: 'center', marginBottom: 20 },
  filterSection: { marginBottom: 20 },
  filterRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 15 },
  ...
  btnOutline: { flex: 1, marginRight: 10, paddingVertical: 12, borderRadius: 25, borderWidth: 1, borderColor: COLORS.primary, alignItems: 'center' },
  btnFilled: { flex: 1, marginLeft: 10, paddingVertical: 12, borderRadius: 25, backgroundColor: COLORS.primary, alignItems: 'center' },
