  ...
  return (
    <View style={styles.splashContainer}>
      ...
      <View style={styles.logoCircle}>
        <Icon name="car-traction-control" size={60} color={COLORS.primary} />
      </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentPadding}>
        ...
        <Text
          style={{ textAlign: 'center', marginVertical: 15, color: '#aaa' }}
        >
          or
        </Text>
        <TouchableOpacity
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <TouchableOpacity style={[styles.primaryButton, { marginTop: 25 }]}>
      ...
      <View style={styles.contentPadding}>
        ...
        <TouchableOpacity
          style={[
            ...
            { width: '100%', alignSelf: 'center', marginTop: 25 },
          ]}
          onPress={() =>
