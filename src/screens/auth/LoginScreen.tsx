...
const styles = StyleSheet.create({
  ...
  logoBox: {
    width: 80, height: 80, backgroundColor: '#EFF6FF', borderRadius: 20,
  ...
  inputContainer: {
    ...
    borderRadius: 12, backgroundColor: '#F8FAFC', height: 50, paddingHorizontal: 12
  },
  ...
  loginButton: {
    backgroundColor: '#2563EB', height: 54, borderRadius: 12,
  ...
  visitorButton: {
    backgroundColor: '#fff', height: 54, borderRadius: 12,
