        ...
        <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            <ScrollView
              ...
              <Text
                style={[styles.inputLabel, {color: theme.subText}]}>
                Store Name *
              </Text>
              ...
              <TextInput
                ...
                onChangeText={v =>
                  setNewStore({...newStore, location: v})
                }
              />
              ...
              <TextInput
                ...
                onChangeText={v =>
                  setNewStore({...newStore, description: v})
                }
              />
            </ScrollView>
...
const styles = StyleSheet.create({
  ...
  addButton:{flexDirection:'row',justifyContent:'center',alignItems:'center',paddingVertical:16,borderRadius:12},
  addText:{color:'#fff',fontSize:16,fontWeight:'bold',marginLeft:8},
  modalOverlay:{flex:1,backgroundColor:'rgba(0,0,0,0.5)',justifyContent:'center',alignItems:'center'},
  modalContent:{width:'90%',borderRadius:16,padding:24,maxHeight:'80%'},
